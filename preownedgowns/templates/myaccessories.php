        ...
        <div id="img_scroller">
            	<?php include("includes/banner.php"); ?>
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM accessories WHERE UserID = ".$_SESSION['is_logged_in']);
            ...
            <div id="content">
                ...
                <div id="right-column-m">
                    <div id="right-heading-msi">
                        <p><?php echo "$count Accesory(s) for Sale"?></p>
                    </div>
                    <div class="clear"></div>
                    <?php
						if($count == 0){
							echo "You do not have any items for sale...";
						}
						if($count >= 1){
							...
							//foreach($results as $result)
								...
								echo '<div class="edit-listing">';
											echo '<p style="font-size: 12px;"><a href="/accessories/look&accessory='.$results['AccessoryType'].'&id='.$results['ID'].'">View </a></p>';
										echo '</div>';
								echo '</div>';
							}
						}
                ...
                <br />
                	<?php
						$result1 = mysql_query("SELECT * FROM tempa WHERE UserID = ".$_SESSION['is_logged_in']);
						$count = mysql_num_rows($result1);
						
						if(!$count == 0){
							echo '<div id="right-column-m1">';
							echo '<div id="right-heading-msi1">';
							echo '<p>'.$count.' Accessory (s) Pending or have Recently Ended</p>';
							echo '</div>';
                                    ...
                                    if($count >= 1){
                                        ...
                                        //foreach($results as $result)
                                            echo '<div class="item-box-list-m">';
                                                ...
                                                echo '</div>';
                                                    echo '<div class="edit-listing">';
                                                        echo '<p style="font-size: 12px;"><a href="https://www.paypal.com/cgi-bin/webscr&cmd=_s-xclick&hosted_button_id=KL4R5QDVU9REN&custom='.$gID.'"><img src="/images/listit.png"  style="border:none; margin-left: -40px; padding-top: 8px;"></a></p>';
                                                    echo '</div>';
                                            echo '</div>';
												}
												elseif($days == 7){
