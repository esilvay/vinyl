        ...
        <div id="main_body">
            ...
            <div id="content">
                <div id="left-column-s">
                    ...
                    <!--<h1>Register</h1>-->
                    <div id="r-form">
            	<form id="gown-list" action="/assets/scripts/admin-list-accessory.php" method="post" name="accessory-list" enctype="multipart/form-data">
            ...
            <p><span>Photos</span></p><br />
            	<p><span style="width: 836px; font-size: 12px;"><i>Acceptable file types: .jpg .png. gif</i></span></p><br />
            	<div class="uploadimage">
						<?php print isset($_SESSION['model']['errormsg']['image1']) ? $_SESSION['model']['errormsg']['image1'] : '';?>
                ...
                <br />
                <div class="left-img" style="float:left; margin-left: 50px;">
...
<p>* I agree to the terms<input type="checkbox" name="termsagree" value="1" id="termsagree" style="width: 10px; height: 10px;"/></p>
