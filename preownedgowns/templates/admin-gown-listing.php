                ...
                <div id="left-column-s">
                    ...
                    <br />
                     <?php
						...
						$result = mysql_query("SELECT Email FROM User WHERE ID = ".$_SESSION['admin_logged_in']);
						$count = mysql_num_rows($result);
						$result = mysql_fetch_assoc($result);
						?>
                    <!--<h1>Register</h1>-->
                    <div id="r-form">
            	<form id="gown-list" action="/assets/scripts/admin-list-gown.php" method="post" name="gown-list" enctype="multipart/form-data">
                        ...
                        <p><span>Preservation Method:</span></p><textarea id="presmethod" class="text_area_input3" name="presmethod" rows="6" cols="30"><?php print isset($_SESSION['model']['params']['presmethod'])?$_SESSION['model']['params']['presmethod']:'';?></textarea><br /><br />
...
<p>* I agree to the terms <a onclick="window.open('terms-conditions.php', 'bwindow', 'width=420, height=475, toolbar=no, directories=no, menubar=no, copyhistory=no, scrollbars=yes'); return false;" href="terms-conditions.php">Terms &amp; Conditions</a><input type="checkbox" name="termsagree" value="1" id="termsagree" style="width: 10px; height: 10px;"/></p>
                    
                    
                       
                    <input type="hidden" name="form_submitted" value="1"/><br />
                    <a href="/admin/home" style="margin: 0 0 0 680px;"><img src="../images/cancel.png" style="border: none; width: 96px; height: 34px;" alt="cancel gown listing"/></a>
