...
if ($_POST['form_submitted'] == '1') {
		...
		header("Location:/admin/home?id=gownlistingsuccess");
		}
		else { 
			session_start();
			$_SESSION['model']['errormsg'] = $errormsg;
			$_SESSION['model']['params'] = $params;
			header("Location:/admin/listgown?id=requiredfieldsmissing");
		}
}
mysql_close($conn);
?>