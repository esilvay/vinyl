...
if(($_SESSION['security_code'] == $_POST['security_code']) && (!empty($_SESSION['security_code'])) ) {
	...
	if ($_POST['form_submitted'] == '1') {
			...
			if ($valid){
					...
					$subject = 'Accessory Listing Item ID# '.$result['ID'].'';
					...
					<p>'.$result['AccessoryType'].'</p>
					<p>$'.$afinal.'</p>
					<p><a href="http://www.preownedgowns.com/accessories/look&accessory='.$result['AccessoryType'].'&id='.$result['ID'].'">Click Here to View Listing</a></p><br />
