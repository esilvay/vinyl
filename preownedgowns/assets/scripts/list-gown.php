...
if ($_POST['form_submitted'] == '1') {
		...
		define('MAX_FILE_SIZE', 2097152); //4mb  //2097152 bytes = 2MB.
		...
		header("Location:/member/mygownsforsale?id=gownlistingsuccess");
		}
		else { 
			session_start();
